...
#include "core/colormap/colormapevaluator.h"
#include <memory>
...
namespace QCP
{
    ...
    extern bool gIsLatexMarkupEnabled;
//    extern int gLegendFrameCornerRadius;
//    extern bool gIsLegendFrameShadowEnabled;
...
public:
  ...
  */
  ...
  int decimation() const { return mDecimation; }
  bool dataLabelsEnabled() const { return mDataLabelsEnabled; }
  QColor dataLabelsFontColor() const { return mDataLabelsFontColor; }
  ...
  void setIcon(const QIcon &icon);//SAE: NOTE: should be used to set icons for scatters(as it allows better size changing)

  void setCustomPath(const QPainterPath &customPath);
  void setDecimation(int decimation);
  void enableDataLabels(bool enabled) { mDataLabelsEnabled = enabled; }
  void setDataLabelsFontColor(const QColor& newColor) { mDataLabelsFontColor = newColor; }
...
protected:
  ...
  //SAE
  int mDecimation;
  bool mDataLabelsEnabled = false;
  QColor mDataLabelsFontColor;
};
...
public:
  ...
  */
  ...
  TickEvaluationPolicy tickEvaluationPolicy() const { return mTickEvalutaionPolicy; }
  LabelDeviationForLeftAxis labelDeviationForLeftAxis() const { return mLabelDeviationForLeftAxis; }
  bool isEdgeTicksModificationEnabled() const { return mIsEdgeTicksModificationEnabled; }
  ...
  void setTickEvaluationPolicy(TickEvaluationPolicy policy);
  void setLabelDeviationForLeftAxis(LabelDeviationForLeftAxis deviation);
  void enableEdgeTicksModification(bool enabled) { mIsEdgeTicksModificationEnabled = enabled; }
...
protected:
  ...
  int mCachedMargin;
  TickEvaluationPolicy mTickEvalutaionPolicy;
  LabelDeviationForLeftAxis mLabelDeviationForLeftAxis;
  bool mIsEdgeTicksModificationEnabled;
...
public:
  ...
  QCPAxis::LabelDeviationForLeftAxis labelDeviationForLeftAxis;
...
public:
  ...
  void enableXAxisDrawingAtCenter(bool status) { mIsXAxisDrawingAtCenterEnabled = status; }
  void enableYAxisDrawingAtCenter(bool status) { mIsYAxisDrawingAtCenterEnabled = status; }
  ...
  bool isXAxisDrawingAtCenterEnabled() const { return mIsXAxisDrawingAtCenterEnabled; }
  bool isYAxisDrawingAtCenterEnabled() const { return mIsYAxisDrawingAtCenterEnabled; }
...
protected:
  ...
  //SAE
  bool mIsXAxisDrawingAtCenterEnabled;
  bool mIsYAxisDrawingAtCenterEnabled;
  //SAE
...
public:
  ...
  */
  ...
  QFont selectedFont() const { return mSelectedFont; }
  QColor selectedTextColor() const { return mSelectedTextColor; }
  int legendFrameCornerRadius() const { return mLegendFrameCornerRadius; }
  bool isLegendFrameShadowEnabled() const { return mIsLegendFrameShadowEnabled; }
  ...
  void setSelectedFont(const QFont &font);
  void setSelectedTextColor(const QColor &color);
  void setLegendFrameCornerRadius(int radius) { mLegendFrameCornerRadius =  radius;}
  void enableLegendFrameShadowEnable(bool status) {mIsLegendFrameShadowEnabled = status; }
  ...
  //SAE
  bool addItemHor(QCPAbstractLegendItem *item);
  bool addItemVer(QCPAbstractLegendItem *item);
  //SAE
  bool removeItem(int index);
...
protected:
  ...
  QFont mSelectedFont;
  QColor mSelectedTextColor;
  int mLegendFrameCornerRadius;
  bool mIsLegendFrameShadowEnabled;
...
public:
  ...
  */
  ...
  //SAE
  BasisFillType fillBasis() const {return mBasisFillType;}
  bool isCustomColormapEnabled() const {return mIsCustomColormapEnabled;}
  //SAE
  ...
  //SAE
  void setFillBasis(BasisFillType fillType);
  void setColorMapEvaluator(std::shared_ptr<ColorMapEvaluator>);
  void enableCustomColormap(bool);
  //SAE
...
protected:
  ...
  //SAE
  BasisFillType mBasisFillType;
  bool mIsCustomColormapEnabled;
...
public:
  ...
  */
  ...
  void setFillBasis(QCPGraph::BasisFillType /*fillType*/) { /*nothing*/; }
...
public:
  ...
  */
  ...
  void setIterpolationType(QCPGraph::LineStyle newStyle);
...
protected:
  ...
  double mGraphKey;
  bool mInterpolating;
  QCPGraph::LineStyle mInterpolationType;
